...
###### Step3  giving a descriptive activity names to activities#############################
###################################################
...
###### Step4  giving an Appropriately labels the data set with descriptive variable names ########
###################################################
...
#Merging Variables into One Tidy Dataset 
